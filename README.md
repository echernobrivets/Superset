...
### Дааный дашборд отображает взаимодейстыия 2-х сервисов приложения, т.е. пользователи, которые пользуются и лентой новостей, и сервисом сообщений. При создании дашборда был написан отдельный SQL-запрос с джоином таблиц с данными новостной ленты и мессенджером.
